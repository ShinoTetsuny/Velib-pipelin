...
spark = SparkSession \
    ...
    .config("spark.mongodb.input.uri", "mongodb://admin:pwd@mongo:27017/velib.velib_data") \
    .config("spark.mongodb.output.uri", "mongodb://admin:pwd@mongo:27017/velib.velib_data") \
